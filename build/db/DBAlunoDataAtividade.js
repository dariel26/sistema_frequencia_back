...
const DBAlunoDataAtividade = {
    buscar: (id_aluno) => __awaiter(void 0, void 0, void 0, function* () {
        const sql = "SELECT * FROM view_presenca WHERE id_aluno IN (?)";
        const [presencas] = yield db_1.default.query(sql, [id_aluno]);
        return presencas;
    }),
    ...
    criar: (dados) => __awaiter(void 0, void 0, void 0, function* () {
        const sql = "INSERT INTO AlunoDataAtividade (id_aluno, id_atividade, estado, data) VALUES ?";
    ...
    deletarSemPresencas: (ids) => __awaiter(void 0, void 0, void 0, function* () {
