...
if (ambiente === "dev") {
    console.log(`Conectado ao banco de dados com sucesso, dados: DB_HOST: ${host} DB_USER: ${user} DB_PASS: ${pass} DB_DATA: ${data} DB_PORT: ${port}`);
}
exports.default = db;
