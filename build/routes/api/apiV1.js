...
const cPresenca_1 = __importDefault(require("../../controllers/cPresenca"));
...
apiV1.post("/usuario/senha", cUsuario_1.default.mudarSenha);
//COORDENADOR
...
apiV1.put("/coordenador", (0, habilidades_1.default)("edit", "coordenador"), cCoordenador_1.default.editarVarios);
...
apiV1.put("/preceptor", (0, habilidades_1.default)("edit", "preceptor"), cPreceptor_1.default.editarVarios);
...
apiV1.put("/aluno", (0, habilidades_1.default)("edit", "aluno"), cAluno_1.default.editarVarios);
...
apiV1.put("/estagio", (0, habilidades_1.default)("edit", "estagio"), cEstagio_1.default.editarVarios);
...
apiV1.put("/grupo", (0, habilidades_1.default)("edit", "grupo"), cGrupo_1.default.editarVarios);
...
apiV1.put("/estagio-grupo", (0, habilidades_1.default)("edit", "estagio-grupo"), cEstagioGrupo_1.default.editarVarios);
...
apiV1.put("/local", (0, habilidades_1.default)("edit", "local"), cLocal_1.default.editarVarios);
...
apiV1.put("/atividade", (0, habilidades_1.default)("edit", "atividade"), cAtividade_1.default.editarVarios);
...
//PRESENCA
apiV1.post("/presenca", (0, habilidades_1.default)("edit", "atividade"), cPresenca_1.default.criarVarias);
apiV1.get("/presenca", (0, habilidades_1.default)("read", "atividade"), cPresenca_1.default.listar);
apiV1.put("/presenca", (0, habilidades_1.default)("edit", "atividade"), cPresenca_1.default.editarVarios);
apiV1.delete("/presenca/:ids", (0, habilidades_1.default)("edit", "atividade"), cPresenca_1.default.deletarVarias);
